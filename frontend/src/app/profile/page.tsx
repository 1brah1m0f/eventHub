...
import { ExternalLink, Pencil, X, Check, Plus, Trash2 } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
        <div className="flex items-start gap-5">
          <div className="w-16 h-16 rounded-full bg-blue-900 flex items-center justify-center text-2xl font-bold text-white shrink-0">
